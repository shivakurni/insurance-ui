        ...
        return (
            <div className="row">
                <div className="container header-title">
                    ...
                    <button className="policy-btn" onClick={this.overallPolicy}>{t('overall')}</button>
                    <button className="policy-sep" >|</button>
                    <button className="policy-btn" onClick={this.topTrending}>{t('trending')}</button>
                    <button className="policy-sep" >|</button>
                    <button className="policy-btn" onClick={this.suggestedPolicy}>{t('suggested')}</button>
                </div>
